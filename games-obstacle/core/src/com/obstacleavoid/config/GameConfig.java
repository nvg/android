...
public class GameConfig {
    ...
    public static final float OBSTACLE_SPAWN_TIME = 0.3f; // spawn obstacle every interval
    public static final float SCORE_MAX_TIME = 0.9f; // add score every interval
    ...
    public static final float PLAYER_BOUNDS_RADIUS = 0.6f; // world units
    public static final float PLAYER_SIZE = 2 * PLAYER_BOUNDS_RADIUS; // world units

    public static final float OBSTACLE_BOUNDS_RADIUS = 0.2f; // world units
